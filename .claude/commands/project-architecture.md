---
description: "Generate a machine-parseable root architecture.md for the solution (consumed by SDD agents)"
argument-hint: <path to repository root, e.g. ./>
---
...
- `{project}` = $ARGUMENTS: absolute or relative path to the repository root.
