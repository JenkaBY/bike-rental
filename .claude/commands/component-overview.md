---
description: "Generate a machine-parseable overview.md for a component (consumed by SDD agents)"
argument-hint: <path to component root>
---
...
- `{project}` = $ARGUMENTS: absolute or relative path to the root of the component/repository to analyse.
...
> **Use the Explore agent** (via the Agent tool, `subagent_type: "Explore"`) to traverse the repository and read files. Invoke it with the
