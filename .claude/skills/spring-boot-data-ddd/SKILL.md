...
- **Aggregates & Entities**: See [references/aggregates.md](references/aggregates.md) for complete patterns with value
  objects, typed IDs, auditing
- **Repositories & Queries**: See [references/repositories.md](references/repositories.md) for custom queries,
  projections, specifications
- **Transactions**: See [references/transactions.md](references/transactions.md) for propagation, isolation,
