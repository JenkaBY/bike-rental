...
description: Spring Boot development best practices. Use when creating or modifying Spring Boot components - dependency injection, configuration properties, controllers, services, data access, and error handling.
---
