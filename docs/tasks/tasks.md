...
1. [Модуль Client (Управление клиентами)](#1-модуль-client-управление-клиентами)
...
## 1. Модуль Client (Управление клиентами)
...
flowchart TD
    ...
    subgraph EquipmentModule["Equipment Module"]
        ...
        EQ003[US-EQ-003<br/>Сканирование NFC]
...
|---|----|----------|-----------|--------|-------------|
| 1 | US-CL-001 | Поиск клиента по номеру телефона | Высокий | client | - |
| 2 | US-CL-002 | Быстрое создание клиента | Высокий | client | - |
| 3 | US-CL-003 | Полное создание/редактирование профиля клиента | Высокий | client | - |
...
| 27 | US-EQ-003 | Сканирование NFC-метки при возврате | Высокий | equipment | US-EQ-001, US-RN-005 |
...
| 34 | US-CL-004 | История аренд клиента | Низкий | client | US-RN-001, US-RN-006 |
| 35 | US-CL-005 | Статистика по клиенту | Низкий | client | US-CL-004 |
