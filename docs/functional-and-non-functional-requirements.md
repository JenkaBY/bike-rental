# Функциональные требования системы BikeRent
...
Данный документ описывает функциональные требования к системе управления прокатом оборудования BikeRent. Требования
