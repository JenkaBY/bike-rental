# Task 002: Create RentalCancelledEventSteps

> **Applied Skill:** `spring-boot-java-cucumber/SKILL.md` — `MessageStore`, Awaitility, event
> assertion pattern

## 1. Objective

Create a Cucumber step definition class that asserts the `RentalCancelled` domain event is
published. Follows the exact pattern of `RentalCompletedEventSteps`.

## 2. File to Modify / Create

* **File Path:**
  `component-test/src/test/java/com/github/jenkaby/bikerental/componenttest/steps/rental/RentalCancelledEventSteps.java`
