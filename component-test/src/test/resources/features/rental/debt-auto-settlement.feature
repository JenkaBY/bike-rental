...
Feature: Automatic DEBT rental settlement on customer deposit
  ...
  Background:
    ...
    And rental equipments exist in the database with the following data
      | rentalId | equipmentId | equipmentUid | tariffId | status   | startedAt           | expectedReturnAt    | estimatedCost | totalCost | createdAt           | updatedAt           |
      | 12       | 1           | BIKE-001     | 1        | RETURNED | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 | 100.00        | 100       | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 |
  ...
  Scenario: Deposit covers oldest DEBT rental but not the next
    ...
    And rental equipments exist in the database with the following data
      | rentalId | equipmentId | equipmentUid | tariffId | status   | startedAt           | expectedReturnAt    | estimatedCost | totalCost | createdAt           | updatedAt           |
      | 13       | 1           | BIKE-001     | 1        | RETURNED | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 | 100.00        | 280       | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 |
    And the deposit request is prepared with the following data
      | idempotencyKey | customerId | amount | paymentMethod | operatorId |
  ...
  Scenario: Deposit covers all DEBT rentals
    ...
    And rental equipments exist in the database with the following data
      | rentalId | equipmentId | equipmentUid | tariffId | status   | startedAt           | expectedReturnAt    | estimatedCost | totalCost | createdAt           | updatedAt           |
      | 13       | 1           | BIKE-001     | 1        | RETURNED | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 | 100.00        | 110       | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 |
    And the deposit request is prepared with the following data
      | idempotencyKey | customerId | amount | paymentMethod | operatorId |
  ...
  Scenario: Deposit covers DEBT rental from HOLD and WALLET
    ...
    And rental equipments exist in the database with the following data
      | rentalId | equipmentId | equipmentUid | tariffId | status   | startedAt           | expectedReturnAt    | estimatedCost | totalCost | createdAt           | updatedAt           |
      | 13       | 1           | BIKE-001     | 1        | RETURNED | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 | 100.00        | 100       | 2026-03-01T08:00:00 | 2026-03-01T08:00:00 |
    And the deposit request is prepared with the following data
      | idempotencyKey | customerId | amount | paymentMethod | operatorId |
