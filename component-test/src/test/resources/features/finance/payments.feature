Feature: Payment acceptance endpoints
  ...
  Scenario Outline: Get payment by id
    ...
    Examples:
      | paymentId | rentalId | amount | type       | method        | createdAt            | operatorId | receipt  |
      | PAY1      | 2001     | 15.00  | PREPAYMENT | BANK_TRANSFER | 2026-02-01T10:00:00Z | OP1        | auto-gen |
  ...
  Scenario Outline: Get payments by rental id
    Given the following payment records exist in db
      ...
      | <paymentId2> | <rentalId> | 12.50  | ADDITIONAL_PAYMENT | BANK_TRANSFER | 2026-02-02T09:05:00Z | <operator> | REC2    |
      | <paymentId3> | 3002       | 13.50  | ADDITIONAL_PAYMENT | BANK_TRANSFER | 2026-02-02T09:06:00Z | <operator> | REC3    |
      | <paymentId4> |            | 14.50  | ADDITIONAL_PAYMENT | BANK_TRANSFER | 2026-02-02T09:07:00Z | <operator> | REC4    |
    ...
    And the payment response only contains list of
      ...
      | <paymentId2> | <rentalId> | 12.50  | ADDITIONAL_PAYMENT | BANK_TRANSFER | REC2    | 2026-02-02T09:05:00Z | <operator> |
    Examples:
  ...
  Scenario Outline: Get payments by rental id when no payments exist
    Given the following payment records exist in db
      | id           | rentalId | amount | type               | method        | createdAt            | operator   | receipt |
      | <paymentId1> | 3002     | 13.50  | ADDITIONAL_PAYMENT | BANK_TRANSFER | 2026-02-02T09:06:00Z | <operator> | REC3    |
    When a GET request has been made to "/api/payments/by-rental/{rentalId}" endpoint with
      | {rentalId} |
      | <rentalId> |
    Then the response status is 200
