...
//       FinanceAccount ids group starts with 44444444-
        ...
        ALIASES.put("ACC5", "44444444-3333-3333-3333-333333333335");
        ...
        ALIASES.put("L_C_W5", "55555555-3333-3333-3333-333333333339");
        ALIASES.put("L_C_H5", "55555555-3333-3333-3333-33333333333a");
        ...
        ALIASES.put("IDK6", "44444444-4444-4444-4444-444444444446");
        ...
        ALIASES.put("TX7", "66666666-6666-6666-6666-666666666667");
        ALIASES.put("TX8", "66666666-6666-6666-6666-666666666668");
        ...
        ALIASES.put("TRE10", "77777777-7777-7777-7777-77777777777a");
        // Transaction ids (continues 6666 group)
        ALIASES.put("TX9", "66666666-6666-6666-6666-666666666669");
        ALIASES.put("TX10", "66666666-6666-6666-6666-66666666666a");
        ALIASES.put("TX11", "66666666-6666-6666-6666-66666666666b");
        ALIASES.put("TX12", "66666666-6666-6666-6666-66666666666c");
        ALIASES.put("TX13", "66666666-6666-6666-6666-66666666666d");
        // Idempotency keys (continues 4444 group)
        ALIASES.put("IDK9", "44444444-4444-4444-4444-444444444449");
        ALIASES.put("IDK10", "44444444-4444-4444-4444-44444444444a");
        ALIASES.put("IDK11", "44444444-4444-4444-4444-44444444444b");
        ALIASES.put("IDK12", "44444444-4444-4444-4444-44444444444c");
        ALIASES.put("IDK13", "44444444-4444-4444-4444-44444444444d");
        // Transaction record entry ids (continues 7777 group)
        ALIASES.put("TRE11", "77777777-7777-7777-7777-77777777777b");
        ALIASES.put("TRE12", "77777777-7777-7777-7777-77777777777c");
        ALIASES.put("TRE13", "77777777-7777-7777-7777-77777777777d");
        ALIASES.put("TRE14", "77777777-7777-7777-7777-77777777777e");
        ALIASES.put("TRE15", "77777777-7777-7777-7777-77777777777f");
        ALIASES.put("TRE16", "77777777-7777-7777-7777-777777777780");
        ALIASES.put("TRE17", "77777777-7777-7777-7777-777777777781");
        ALIASES.put("TRE18", "77777777-7777-7777-7777-777777777782");
