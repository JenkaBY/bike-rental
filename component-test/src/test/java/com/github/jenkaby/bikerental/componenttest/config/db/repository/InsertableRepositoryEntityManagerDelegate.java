...
@Repository
@Transactional
public class InsertableRepositoryEntityManagerDelegate<ENTITY, ID> implements InsertableRepository<ENTITY, ID> {

    private final EntityManager entityManager;

    public InsertableRepositoryEntityManagerDelegate(EntityManager entityManager) {
