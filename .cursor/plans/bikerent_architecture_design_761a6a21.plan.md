---
name: BikeRent Architecture Design
overview: "Модульная архитектура системы BikeRent на базе Spring Modulith с 8 доменными модулями, соответствующими функциональным требованиям: Client, Equipment, Rental, Tariff, Finance, Reporting, Maintenance, Admin."
todos:
  - id: client-module
    content: "Реализация модуля Client: сущности Customer, поиск по телефону, CRUD операции"
    status: pending
  - id: equipment-module
    content: "Реализация модуля Equipment: каталог оборудования, статусы, поиск по номеру"
    status: pending
  - id: tariff-module
    content: "Реализация модуля Tariff: справочник тарифов, RentalCostCalculator с бизнес-правилами"
    status: pending
  - id: rental-module
    content: "Реализация модуля Rental: полный цикл аренды, use cases, события"
    status: pending
  - id: finance-module
    content: "Реализация модуля Finance: платежи, касса, обработка событий аренды"
    status: pending
  - id: reporting-module
    content: "Реализация модуля Reporting: отчеты по доходам, загрузке, клиентам"
    status: pending
  - id: admin-module
    content: "Реализация модуля Admin: пользователи, роли, настройки, аудит"
    status: pending
  - id: maintenance-module
    content: "Реализация модуля Maintenance: записи ТО, планирование обслуживания"
    status: pending
  - id: modulith-tests
    content: Настройка тестов Spring Modulith для валидации архитектуры
    status: pending
  - id: db-migrations
    content: Создание Liquibase миграций для всех сущностей
    status: pending
---
...
клиентов, финансовых операций и технического обслуживания для повышения операционной эффективности и качества
