    ...
    class FindTransactions {
        ...
        void shouldReturn200WithPagedTransactionsCarryingAllLegs() throws Exception {
            var dto = new TransactionListItemDto(
                    UUID.fromString("018e2cc3-0002-7000-8000-000000000002"),
                    CUSTOMER_ID,
                    ...
                    "operator-1",
                    List.of(
                            new TransactionListItemDto.Entry(LedgerType.CASH, EntryDirection.DEBIT, new BigDecimal("50.00")),
                            new TransactionListItemDto.Entry(LedgerType.CUSTOMER_WALLET, EntryDirection.CREDIT, new BigDecimal("50.00"))));
            var pageRequest = new PageRequest(20, 0);
            var page = new Page<>(List.of(dto), 1L, pageRequest);
            ...
            given(mapper.toResponse(dto)).willReturn(response);
            ...
            mockMvc.perform(get(TRANSACTIONS_ENDPOINT)
                    ...
                    .andExpect(jsonPath("$.items[0].id").value(dto.id().toString()))
