...
public class QuoteAlreadyConsumedException extends BikeRentalException {
    ...
    public static final String ERROR_CODE = "tariff.quote.already_consumed";

    private static final String MESSAGE_TEMPLATE = "Cost quote '%s' has already been consumed";

    public QuoteAlreadyConsumedException(UUID quoteId) {
