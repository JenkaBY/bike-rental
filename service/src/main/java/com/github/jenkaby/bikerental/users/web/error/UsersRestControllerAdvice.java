package com.github.jenkaby.bikerental.users.web.error;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.github.jenkaby.bikerental.users")
@Order(Ordered.LOWEST_PRECEDENCE - 1)
@RequiredArgsConstructor
public class UsersRestControllerAdvice {
