...
public class ErrorCodes {
    ...
    public static final String REQUEST_NOT_READABLE = "shared.request.not_readable";
    public static final String METHOD_NOT_ALLOWED = "shared.request.method_not_allowed";
    public static final String MEDIA_TYPE_NOT_SUPPORTED = "shared.request.media_type_not_supported";
    public static final String API_VERSION_MISSING = "shared.api.version_missing";
    public static final String API_VERSION_INVALID = "shared.api.version_invalid";
    ...
    public static final String EQUIPMENT_NOT_IN_GOOD_STATE = "shared.equipment.not_available";
