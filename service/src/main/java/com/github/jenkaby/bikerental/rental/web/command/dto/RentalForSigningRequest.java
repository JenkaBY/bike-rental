...
@Schema(description = "Request body for creating a rental directly in AWAITING_SIGNATURE")
public record RentalForSigningRequest(
        @Schema(description = "Customer UUID")
        @NotNull(message = "Customer ID is required")
        UUID customerId,

        @Schema(description = "List of Equipment IDs to rent; at least one is required")
        @NotNull
