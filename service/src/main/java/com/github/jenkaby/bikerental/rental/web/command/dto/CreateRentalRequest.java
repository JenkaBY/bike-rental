...
public record CreateRentalRequest(
        ...
        @Schema(description = "Planned rental duration in minutes", example = "120") @NotNull(message = "Duration is required") @Positive(message = "Duration must be positive") Integer duration,
